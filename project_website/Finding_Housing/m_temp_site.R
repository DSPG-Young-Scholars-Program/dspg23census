...
#Mission statements
#Wordcloud of mission statements - creates string of all characters in mission statement
...
")),
  ...
  tabPanel("Topic Modeling",
           ...
           box(h3("BERT", style = "color: #1B3766;"),
               ...
               p("4.Oregon"),
               p("5.Texas")),
           box(h3("BERT Example: California Data", style = "color: #1B3766;"),
               br(),
  ...
  navbarMenu("State Data Center Findings",
             ...
             tabPanel("Housing",
                      ...
                      br(),
                      fluidRow(
                        column(width=6, plotOutput("fin_hous_plot5"), plotOutput("fin_hous_plot7")),        
                        column(width=6, plotOutput("fin_hous_plot6"), plotOutput("fin_hous_plot8")))),
             tabPanel("Diversity",
             ...
             tabPanel("Health & Education",
                      ...
                      br(),
                      fluidRow(column(width=6, plotOutput("fin_HE_plot5"), plotOutput("fin_HE_plot7")),
                               column(width=6, plotOutput("fin_HE_plot6"), plotOutput("fin_HE_plot8")))),
...
server <- function(input, output) {
  ...
  output$fin_hous_plot3 <- renderPlot({age_of_data_plot(state=input$dropdownH, data_source = housing_data)})
  ...
  output$fin_HE_plot3 <- renderPlot({age_of_data_plot(state=input$dropdownHE, data_source = HE_data)})
